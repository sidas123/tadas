...
<div class='ressed'>
		...
		nustatimai<hr>
		<br>
<form action='delkip.php' method='post' ><input type='hidden' value='$namem' name='namem'>
trinti acc:<input type='submit' value='taip' name='$namem'>
</form>
</div>
<div class='sfs'></div>
...
<div class='pmenu'>
profilis<br>
nick: <b> $namem </b><br><hr>
tavo grupe:<div class='colorgroup'><b> $gr </b> </div>
<hr>
gmail: $dukh[2]<br>
<hr>
registracijos data: <b>".date("Y-m-d H:i:s",$dukh[3])."</b><br><hr>
paskutini kart buvai tikrintas: ".date("Y-m-d H:i:s",$kol)."
</div>
