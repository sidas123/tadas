...
<ul class='gh'><form action='onl.php' class='gg' method='post'><input type='hidden' value='$namem' name='gsg'><input type='hidden' value='$pass' name='gsggt'><input class='aaasss'type='submit' value='pradinis' >
  ...
  <li class='hhhh'><form class='gggg'action='vsg.php' method='post'><input type='hidden' value='$namem' name='gsg'><input type='hidden' value='$pass' name='gsggt'><input class='inttee' type='submit' value='nariu listas' >
</form</li>
</ul>
